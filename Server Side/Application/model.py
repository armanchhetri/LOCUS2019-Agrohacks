...
class Dairy(db.Model):
    ...
    milk=db.Column(db.Float,nullable=False)
    cheese=db.Column(db.Float,nullable=False)
    ghee=db.Column(db.Float,nullable=False)
    curd=db.Column(db.Float,nullable=False)
